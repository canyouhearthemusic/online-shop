...
import (
	...
	"github.com/canyouhearthemusic/online-shop/product-service/internal/handler/httphandler"
...
func WithHTTPHandler() Configuration {
	return func(h *Handler) error {
		...
		productHandler := httphandler.NewProductHandler(h.deps.OnlineShopService)
